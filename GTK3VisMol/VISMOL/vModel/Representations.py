...
class Representation:
    ...
    def _make_gl_representation_vao_and_vbos(self, indexes=None, coords=None, colors=None, dot_sizes=None, normals=None):
        """ Function doc """
    ...
    def _make_gl_sel_representation_vao_and_vbos(self, indexes=None, coords=None, colors=None, dot_sizes=None):
        """ Function doc """
...
class LinesRepresentation(Representation):
    ...
    def _make_gl_vao_and_vbos(self, indexes=None):
        ...
        self._make_gl_representation_vao_and_vbos(indexes=indexes, coords=coords, colors=colors, dot_sizes=None)
        colors_idx = self.visObj.color_indexes
        self._make_gl_sel_representation_vao_and_vbos(indexes=indexes, coords=coords, colors=colors_idx, dot_sizes=None)
...
class DynamicBonds(Representation):
    ...
    def __init__(self, name='sticks', active=True, _type='mol', visObj=None, glCore=None, indexes=None):
        """ Class initialiser """
        self.name               = name
        self.active             = active
        self.type               = _type
    ...
    def _make_gl_vao_and_vbos(self, indexes=None):
        ...
        self._make_gl_representation_vao_and_vbos(indexes=self.indexes, coords=coords, colors=colors, dot_sizes=None)
        colors_idx = self.visObj.color_indexes
        self._make_gl_sel_representation_vao_and_vbos(indexes=self.indexes, coords=coords, colors=colors_idx, dot_sizes=None)
...
class DotsRepresentation(Representation):
    ...
    def __init__(self, name='dots', active=True, _type='mol', visObj=None, glCore=None, indexes=None):
        """ Class initialiser """
        self.name               = name
        self.active             = active
        self.type               = _type
...
class SpheresRepresentation(Representation):
    ...
    def __init__(self, name='spheres', active=True, _type='mol', visObj=None, glCore=None, atoms=None):
        """ Class initialiser """
        self.name               = name
        self.active             = active
        self.type               = _type
    ...
    def _update_sphere_data_to_VBOs(self):
        ...
        GL.glBindBuffer(GL.GL_ARRAY_BUFFER, self.center_vbo)
    ...
    def _make_gl_vao_and_vbos(self):
        ...
        self.center_vbo = GL.glGenBuffers(1)
        GL.glBindBuffer(GL.GL_ARRAY_BUFFER, self.center_vbo)
        GL.glBufferData(GL.GL_ARRAY_BUFFER, self.centers.itemsize*len(self.centers), self.centers, GL.GL_STATIC_DRAW)
        ...
        self.triangles = int(len(self.indexes))
        colors_idx = self.visObj.color_indexes
        self._make_gl_sel_representation_vao_and_vbos(indexes=self.indexes, coords=self.coords, colors=colors_idx, dot_sizes=None)
...
class CartoonRepresentation(Representation):
    def __init__(self, name='cartoon', active=True, _type='mol', visObj=None, glCore=None, indexes = None):
        self.name               = name
        self.active             = active
        self.type               = _type
        self.visObj             = visObj
    ...
    def _make_gl_vao_and_vbos(self, indexes=None):
        ...
        self._make_gl_representation_vao_and_vbos(indexes=indexes, coords=coords, colors=colors, dot_sizes=None, normals=normals)
        self.ind_vbo = GL.glGenBuffers(1)
        GL.glBindBuffer(GL.GL_ELEMENT_ARRAY_BUFFER, self.ind_vbo)
...
class SurfaceRepresentation(Representation):
    ...
    def __init__(self, name='surface', active=True, _type='mol', visObj=None, glCore=None, indexes=None):
        """ Class initialiser """
        self.name               = name
        self.active             = active
        self.type               = _type
...
class WiresRepresentation(Representation):
    ...
    def __init__(self, name='wires', active=True, _type='mol', visObj=None, glCore=None, indexes=None):
        """ Class initialiser """
        self.name               = name
        self.active             = active
        self.type               = _type
...
class LabelRepresentation:
    ...
    def __init__(self, name='labels', active=True, _type='mol', visObj=None, glCore=None, indexes=None):
        """ Class initialiser """
        self.visObj = visObj
        self.name = name
        self.active = True
    ...
    def draw_representation(self):
        ...
        self.visObj.vm_font.load_matrices(self.glCore.freetype_program,
                                          self.glCore.model_mat,
                                          self.glCore.glcamera.view_matrix,
                                          self.glCore.glcamera.projection_matrix)
