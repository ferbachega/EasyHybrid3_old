...
def _make_gl_sphere_dots_old(program, vismol_object = None, bckgrnd_color= [0.0,0.0,0.0,1.0]):
    ...
    vismol_object.sphere_dots_vao       = vao
    vismol_object.sphere_dots_buffers   = (ind_vbo, coord_vbo, col_vbo)
...
'''
def _make_sel_gl_lines_old(program, vismol_object = None):#, lines_vao = None, lines_buffers = None ):
    """ Function doc
    """
