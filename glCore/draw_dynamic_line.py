...
class DynamicLine:
    ...
    def __init__ (self):
        ...
        self.vao = None
        self.buffers = None
        self.dynamic_line_program = None
        self.start = None
        self.end = None
        self.points = None
        self.color = np.array([0.5, 0.5, 0.5]*5, dtype=np.float32)
...
"""
    ...
    def initialize_gl(self):
        """ Gives the order to create and compile the OpenGL program. Maybe this
            ...
            with GLAxis class.
        """
        self._make_dynamic_line_program()
        return True
    
    def _make_dynamic_line_program(self):
        ...
        self.dynamic_line_program = GL.glCreateProgram()
        GL.glAttachShader(self.dynamic_line_program, v_shader)
        GL.glAttachShader(self.dynamic_line_program, f_shader)
        GL.glLinkProgram(self.dynamic_line_program)
    ...
    def _make_gl_selection_box(self):
        ...
        att_position = GL.glGetAttribLocation(self.dynamic_line_program, 'vert_coord')
        ...
        att_colors = GL.glGetAttribLocation(self.dynamic_line_program, 'vert_color')
    ...
    def _draw_selection_box(self):
        ...
        """
        GL.glUseProgram(self.dynamic_line_program)
        GL.glLineWidth(1)
        GL.glBindVertexArray(self.vao)
